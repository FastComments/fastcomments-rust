...
**data** | Option<[**std::collections::HashMap<String, models::QuestionResultAggregationOverall>**](QuestionResultAggregationOverall.md)> | Construct a type with a set of properties K of type T | [optional]
