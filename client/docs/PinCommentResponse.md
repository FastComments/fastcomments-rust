...
------------ | ------------- | ------------- | -------------
**comment_positions** | Option<[**std::collections::HashMap<String, models::RecordStringBeforeStringOrNullAfterStringOrNullValue>**](RecordStringBeforeStringOrNullAfterStringOrNullValue.md)> | Construct a type with a set of properties K of type T | [optional]
