...
------------ | ------------- | ------------- | -------------
**name** | **String** |  | 
**monthly_cost_usd** | Option<**f64**> |  | [optional]
**yearly_cost_usd** | Option<**f64**> |  | [optional]
**monthly_stripe_plan_id** | Option<**String**> |  | [optional]
**yearly_stripe_plan_id** | Option<**String**> |  | [optional]
**max_monthly_page_loads** | **f64** |  | 
**max_monthly_api_credits** | **f64** |  | 
**max_monthly_small_widgets_credits** | Option<**f64**> |  | [optional]
...
**max_moderators** | **f64** |  | 
**max_domains** | **f64** |  | 
**max_white_labeled_tenants** | Option<**f64**> |  | [optional]
**max_monthly_event_log_requests** | Option<**f64**> |  | [optional]
**max_custom_collection_size** | Option<**f64**> |  | [optional]
**has_white_labeling** | Option<**bool**> |  | [optional]
**has_debranding** | **bool** |  | 
**has_llm_spam_detection** | Option<**bool**> |  | [optional]
**for_who_text** | **String** |  | 
