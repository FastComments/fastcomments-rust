...
**question_values** | Option<[**std::collections::HashMap<String, models::GifSearchResponseImagesInnerInner>**](GifSearchResponseImagesInnerInner.md)> | Construct a type with a set of properties K of type T | [optional]
