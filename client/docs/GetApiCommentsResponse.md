...
**translations** | Option<**serde_json::Value**> |  | [optional]
**comments** | Option<[**Vec<models::ModerationApiComment>**](ModerationAPIComment.md)> |  | [optional]
**moderation_filter** | Option<[**models::ModerationFilter**](ModerationFilter.md)> |  | [optional]
