...
pub struct GetSearchSitesResponse {
    #[serde(rename = "sites", skip_serializing_if = "Option::is_none")]
    pub sites: Option<Vec<models::ModerationSiteSearchProjected>>,
    #[serde(rename = "status")]
...
impl GetSearchSitesResponse {
    pub fn new(status: models::ApiStatus) -> GetSearchSitesResponse {
