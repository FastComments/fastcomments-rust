...
pub struct GetUserPresenceStatusesResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    /// Construct a type with a set of properties K of type T
    #[serde(rename = "userIdsOnline", skip_serializing_if = "Option::is_none")]
    pub user_ids_online: Option<std::collections::HashMap<String, bool>>,
...
impl GetUserPresenceStatusesResponse1 {
    pub fn new(status: models::ApiStatus) -> GetUserPresenceStatusesResponse1 {
        GetUserPresenceStatusesResponse1 {
            status,
            user_ids_online: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
