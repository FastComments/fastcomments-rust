...
pub struct GetQuestionResult200Response {
    #[serde(rename = "status")]
...
impl GetQuestionResult200Response {
    pub fn new(status: models::ApiStatus, question_result: models::QuestionResult, reason: String, code: String) -> GetQuestionResult200Response {
