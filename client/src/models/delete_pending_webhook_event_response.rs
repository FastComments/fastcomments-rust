...
pub struct DeletePendingWebhookEventResponse {
    #[serde(rename = "status")]
...
impl DeletePendingWebhookEventResponse {
    pub fn new(status: models::ApiStatus) -> DeletePendingWebhookEventResponse {
