...
impl PubSubComment {
    pub fn new(_id: String, url_id: String, url: String, date: String, tenant_id: String, commenter_name: String, comment: String, comment_html: String, verified: bool, approved: bool, locale: String) -> PubSubComment {
        PubSubComment {
            _id,
            url_id,
            url,
