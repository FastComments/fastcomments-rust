...
pub struct GetManualBadgesForUserResponse {
    #[serde(rename = "badges", skip_serializing_if = "Option::is_none")]
    pub badges: Option<Vec<models::UserBadge>>,
    #[serde(rename = "status")]
...
impl GetManualBadgesForUserResponse {
    pub fn new(status: models::ApiStatus) -> GetManualBadgesForUserResponse {
