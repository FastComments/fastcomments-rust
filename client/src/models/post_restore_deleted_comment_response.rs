...
pub struct PostRestoreDeletedCommentResponse {
    #[serde(rename = "status")]
...
impl PostRestoreDeletedCommentResponse {
    pub fn new(status: models::ApiStatus) -> PostRestoreDeletedCommentResponse {
