...
pub struct ReplaceTenantUserBody {
    ...
    #[serde(rename = "createdFromTenantId", skip_serializing_if = "Option::is_none")]
...
impl ReplaceTenantUserBody {
    pub fn new(username: String, email: String) -> ReplaceTenantUserBody {
