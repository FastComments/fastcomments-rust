...
pub struct GetCommentTextResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "commentText", skip_serializing_if = "Option::is_none")]
    pub comment_text: Option<String>,
    #[serde(rename = "sanitizedCommentText", skip_serializing_if = "Option::is_none")]
    pub sanitized_comment_text: Option<String>,
...
impl GetCommentTextResponse1 {
    pub fn new(status: models::ApiStatus) -> GetCommentTextResponse1 {
        GetCommentTextResponse1 {
            status,
            comment_text: None,
            sanitized_comment_text: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
