...
pub struct GetQuestionConfigs200Response {
    #[serde(rename = "status")]
...
impl GetQuestionConfigs200Response {
    pub fn new(status: models::ApiStatus, question_configs: Vec<models::QuestionConfig>, reason: String, code: String) -> GetQuestionConfigs200Response {
