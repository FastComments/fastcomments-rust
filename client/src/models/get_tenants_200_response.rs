...
pub struct GetTenants200Response {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenants")]
    pub tenants: Vec<models::ApiTenant>,
    #[serde(rename = "reason")]
    pub reason: String,
    #[serde(rename = "code")]
    pub code: String,
...
impl GetTenants200Response {
    pub fn new(status: models::ApiStatus, tenants: Vec<models::ApiTenant>, reason: String, code: String) -> GetTenants200Response {
