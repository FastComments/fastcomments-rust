...
pub struct CreateQuestionConfigResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "questionConfig", skip_serializing_if = "Option::is_none")]
    pub question_config: Option<Box<models::QuestionConfig>>,
...
impl CreateQuestionConfigResponse1 {
    pub fn new(status: models::ApiStatus) -> CreateQuestionConfigResponse1 {
