...
pub struct GetModerationCommentResponse {
    #[serde(rename = "comment", skip_serializing_if = "Option::is_none")]
    pub comment: Option<Box<models::ModerationApiComment>>,
    #[serde(rename = "status")]
...
impl GetModerationCommentResponse {
    pub fn new(status: models::ApiStatus) -> GetModerationCommentResponse {
