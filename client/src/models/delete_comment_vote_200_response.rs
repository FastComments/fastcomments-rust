...
pub struct DeleteCommentVote200Response {
    #[serde(rename = "status")]
...
impl DeleteCommentVote200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, reason: String, code: String) -> DeleteCommentVote200Response {
