...
pub struct CombineCommentsWithQuestionResultsResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::FindCommentsByRangeResponse>>,
...
impl CombineCommentsWithQuestionResultsResponse {
    pub fn new(status: models::ApiStatus) -> CombineCommentsWithQuestionResultsResponse {
