...
pub struct FlagCommentPublic200Response {
    #[serde(rename = "status")]
...
impl FlagCommentPublic200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, reason: String, code: String) -> FlagCommentPublic200Response {
