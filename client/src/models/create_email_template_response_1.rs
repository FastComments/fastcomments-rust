...
pub struct CreateEmailTemplateResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "emailTemplate", skip_serializing_if = "Option::is_none")]
    pub email_template: Option<Box<models::CustomEmailTemplate>>,
...
impl CreateEmailTemplateResponse1 {
    pub fn new(status: models::ApiStatus) -> CreateEmailTemplateResponse1 {
