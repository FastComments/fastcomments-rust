...
pub struct CreateEmailTemplate200Response {
    #[serde(rename = "status")]
...
impl CreateEmailTemplate200Response {
    pub fn new(status: models::ApiStatus, email_template: models::CustomEmailTemplate, reason: String, code: String) -> CreateEmailTemplate200Response {
