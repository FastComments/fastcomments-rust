...
impl PubSubCommentBase {
    pub fn new(_id: String, tenant_id: String, url_id: String, commenter_name: String, comment_html: String, comment: String, verified: bool, url: String, approved: bool, locale: Option<String>) -> PubSubCommentBase {
        PubSubCommentBase {
            _id,
            tenant_id,
            user_id: None,
