...
pub struct GetQuestionConfigsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "questionConfigs", skip_serializing_if = "Option::is_none")]
    pub question_configs: Option<Vec<models::QuestionConfig>>,
...
impl GetQuestionConfigsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetQuestionConfigsResponse1 {
