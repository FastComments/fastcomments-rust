...
pub struct DeleteCommentPublicResponse {
    #[serde(rename = "comment", skip_serializing_if = "Option::is_none")]
    pub comment: Option<Box<models::DeletedCommentResultComment>>,
    #[serde(rename = "hardRemoved", skip_serializing_if = "Option::is_none")]
    pub hard_removed: Option<bool>,
    #[serde(rename = "status")]
...
impl DeleteCommentPublicResponse {
    pub fn new(status: models::ApiStatus) -> DeleteCommentPublicResponse {
