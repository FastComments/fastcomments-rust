...
pub struct CreateTicket200Response {
    #[serde(rename = "status")]
...
impl CreateTicket200Response {
    pub fn new(status: models::ApiStatus, ticket: models::ApiTicket, reason: String, code: String) -> CreateTicket200Response {
