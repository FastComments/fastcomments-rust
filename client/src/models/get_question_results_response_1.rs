...
pub struct GetQuestionResultsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "questionResults", skip_serializing_if = "Option::is_none")]
    pub question_results: Option<Vec<models::QuestionResult>>,
...
impl GetQuestionResultsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetQuestionResultsResponse1 {
