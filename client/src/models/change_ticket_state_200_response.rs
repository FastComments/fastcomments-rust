...
pub struct ChangeTicketState200Response {
    #[serde(rename = "status")]
...
impl ChangeTicketState200Response {
    pub fn new(status: models::ApiStatus, ticket: models::ApiTicket, reason: String, code: String) -> ChangeTicketState200Response {
