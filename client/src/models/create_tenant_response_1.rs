...
pub struct CreateTenantResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenant", skip_serializing_if = "Option::is_none")]
    pub tenant: Option<Box<models::ApiTenant>>,
...
impl CreateTenantResponse1 {
    pub fn new(status: models::ApiStatus) -> CreateTenantResponse1 {
