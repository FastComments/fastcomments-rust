...
pub struct PostSetCommentReviewStatusResponse {
    #[serde(rename = "status")]
...
impl PostSetCommentReviewStatusResponse {
    pub fn new(status: models::ApiStatus) -> PostSetCommentReviewStatusResponse {
