...
pub struct GetPendingWebhookEventsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "pendingWebhookEvents", skip_serializing_if = "Option::is_none")]
    pub pending_webhook_events: Option<Vec<models::PendingCommentToSyncOutbound>>,
...
impl GetPendingWebhookEventsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetPendingWebhookEventsResponse1 {
        GetPendingWebhookEventsResponse1 {
            status,
            pending_webhook_events: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
