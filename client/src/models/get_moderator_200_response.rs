...
pub struct GetModerator200Response {
    #[serde(rename = "status")]
...
impl GetModerator200Response {
    pub fn new(status: models::ApiStatus, moderator: models::Moderator, reason: String, code: String) -> GetModerator200Response {
