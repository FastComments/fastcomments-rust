...
pub struct CreateModerator200Response {
    #[serde(rename = "status")]
...
impl CreateModerator200Response {
    pub fn new(status: models::ApiStatus, moderator: models::Moderator, reason: String, code: String) -> CreateModerator200Response {
