...
pub struct CreateFeedPost200Response {
    #[serde(rename = "status")]
...
impl CreateFeedPost200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, feed_post: models::FeedPost, reason: String, code: String) -> CreateFeedPost200Response {
