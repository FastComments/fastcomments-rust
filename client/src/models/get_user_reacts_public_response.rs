...
pub struct GetUserReactsPublicResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "reacts", skip_serializing_if = "Option::is_none")]
    pub reacts: Option<std::collections::HashMap<String, std::collections::HashMap<String, bool>>>,
...
impl GetUserReactsPublicResponse {
    pub fn new(status: models::ApiStatus) -> GetUserReactsPublicResponse {
