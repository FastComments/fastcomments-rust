...
pub struct GetNotificationsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "notifications", skip_serializing_if = "Option::is_none")]
    pub notifications: Option<Vec<models::UserNotification>>,
...
impl GetNotificationsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetNotificationsResponse1 {
