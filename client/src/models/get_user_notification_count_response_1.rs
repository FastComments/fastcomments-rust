...
pub struct GetUserNotificationCountResponse1 {
    #[serde(rename = "status")]
...
impl GetUserNotificationCountResponse1 {
    pub fn new(status: models::ApiStatus) -> GetUserNotificationCountResponse1 {
