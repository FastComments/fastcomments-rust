...
pub struct PostSetCommentTextResponse {
    #[serde(rename = "newCommentTextHTML", skip_serializing_if = "Option::is_none")]
    pub new_comment_text_html: Option<String>,
    #[serde(rename = "status")]
...
impl PostSetCommentTextResponse {
    pub fn new(status: models::ApiStatus) -> PostSetCommentTextResponse {
        PostSetCommentTextResponse {
            new_comment_text_html: None,
            status,
            reason: None,
            code: None,
            secondary_code: None,
