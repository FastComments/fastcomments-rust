...
pub struct AggregateQuestionResultsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::QuestionResultAggregationOverall>>,
...
impl AggregateQuestionResultsResponse1 {
    pub fn new(status: models::ApiStatus) -> AggregateQuestionResultsResponse1 {
