...
pub struct UnBlockComment200Response {
    #[serde(rename = "status")]
...
impl UnBlockComment200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, comment_statuses: std::collections::HashMap<String, bool>, reason: String, code: String) -> UnBlockComment200Response {
