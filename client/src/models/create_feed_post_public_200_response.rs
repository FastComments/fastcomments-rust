...
pub struct CreateFeedPostPublic200Response {
    #[serde(rename = "status")]
...
impl CreateFeedPostPublic200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, feed_post: models::FeedPost, reason: String, code: String) -> CreateFeedPostPublic200Response {
