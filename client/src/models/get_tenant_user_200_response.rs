...
pub struct GetTenantUser200Response {
    #[serde(rename = "status")]
...
impl GetTenantUser200Response {
    pub fn new(status: models::ApiStatus, tenant_user: models::User, reason: String, code: String) -> GetTenantUser200Response {
