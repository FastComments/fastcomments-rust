...
pub struct GetCachedNotificationCountResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::UserNotificationCount>>,
...
impl GetCachedNotificationCountResponse1 {
    pub fn new(status: models::ApiStatus) -> GetCachedNotificationCountResponse1 {
