...
pub struct GetTenantPackages200Response {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantPackages")]
    pub tenant_packages: Vec<models::TenantPackage>,
    #[serde(rename = "reason")]
    pub reason: String,
    #[serde(rename = "code")]
    pub code: String,
...
impl GetTenantPackages200Response {
    pub fn new(status: models::ApiStatus, tenant_packages: Vec<models::TenantPackage>, reason: String, code: String) -> GetTenantPackages200Response {
