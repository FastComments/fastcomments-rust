...
impl PickApiCommentPeriodUpdatableCommentFields {
    ...
    pub fn new(url_id: String, url: String, date: String, commenter_name: String, comment: String, comment_html: String, verified: bool, approved: bool) -> PickApiCommentPeriodUpdatableCommentFields {
