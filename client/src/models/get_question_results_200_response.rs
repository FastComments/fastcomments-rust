...
pub struct GetQuestionResults200Response {
    #[serde(rename = "status")]
...
impl GetQuestionResults200Response {
    pub fn new(status: models::ApiStatus, question_results: Vec<models::QuestionResult>, reason: String, code: String) -> GetQuestionResults200Response {
