...
pub struct GetBanUsersFromCommentResponse {
    #[serde(rename = "bannedUsers", skip_serializing_if = "Option::is_none")]
    pub banned_users: Option<Vec<models::ApiBannedUserWithMultiMatchInfo>>,
...
impl GetBanUsersFromCommentResponse {
    pub fn new(status: models::ApiStatus) -> GetBanUsersFromCommentResponse {
