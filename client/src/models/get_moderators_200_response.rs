...
pub struct GetModerators200Response {
    #[serde(rename = "status")]
...
impl GetModerators200Response {
    pub fn new(status: models::ApiStatus, moderators: Vec<models::Moderator>, reason: String, code: String) -> GetModerators200Response {
