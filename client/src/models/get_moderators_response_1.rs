...
pub struct GetModeratorsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "moderators", skip_serializing_if = "Option::is_none")]
    pub moderators: Option<Vec<models::Moderator>>,
...
impl GetModeratorsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetModeratorsResponse1 {
