...
pub struct GetEmailTemplate200Response {
    #[serde(rename = "status")]
...
impl GetEmailTemplate200Response {
    pub fn new(status: models::ApiStatus, email_template: models::CustomEmailTemplate, reason: String, code: String) -> GetEmailTemplate200Response {
