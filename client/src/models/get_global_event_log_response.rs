...
pub struct GetGlobalEventLogResponse {
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::EventLogEntry>>,
    #[serde(rename = "status")]
...
impl GetGlobalEventLogResponse {
    pub fn new(status: models::ApiStatus) -> GetGlobalEventLogResponse {
