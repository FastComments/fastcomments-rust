...
pub struct DeleteFeedPostPublic200Response {
    #[serde(rename = "status")]
...
impl DeleteFeedPostPublic200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, reason: String, code: String) -> DeleteFeedPostPublic200Response {
