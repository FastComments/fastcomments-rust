...
pub struct PostAdjustCommentVotesResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "newCommentVotes", skip_serializing_if = "Option::is_none")]
    pub new_comment_votes: Option<i32>,
...
impl PostAdjustCommentVotesResponse {
    pub fn new(status: models::ApiStatus) -> PostAdjustCommentVotesResponse {
        PostAdjustCommentVotesResponse {
            status,
            new_comment_votes: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
