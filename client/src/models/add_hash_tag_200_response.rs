...
pub struct AddHashTag200Response {
    #[serde(rename = "status")]
...
impl AddHashTag200Response {
    pub fn new(status: models::ApiStatus, hash_tag: models::TenantHashTag, reason: String, code: String) -> AddHashTag200Response {
