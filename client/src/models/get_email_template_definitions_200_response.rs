...
pub struct GetEmailTemplateDefinitions200Response {
    #[serde(rename = "status")]
...
impl GetEmailTemplateDefinitions200Response {
    pub fn new(status: models::ApiStatus, definitions: Vec<models::EmailTemplateDefinition>, reason: String, code: String) -> GetEmailTemplateDefinitions200Response {
