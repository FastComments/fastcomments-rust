...
pub struct GetManualBadgesResponse {
    #[serde(rename = "badges", skip_serializing_if = "Option::is_none")]
    pub badges: Option<Vec<models::TenantBadge>>,
    #[serde(rename = "status")]
...
impl GetManualBadgesResponse {
    pub fn new(status: models::ApiStatus) -> GetManualBadgesResponse {
