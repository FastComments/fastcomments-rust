...
pub struct RenderEmailTemplate200Response {
    #[serde(rename = "status")]
...
impl RenderEmailTemplate200Response {
    pub fn new(status: models::ApiStatus, html: String, reason: String, code: String) -> RenderEmailTemplate200Response {
