...
pub struct GetHashTags200Response {
    #[serde(rename = "status")]
...
impl GetHashTags200Response {
    pub fn new(status: models::ApiStatus, hash_tags: Vec<models::TenantHashTag>, reason: String, code: String) -> GetHashTags200Response {
