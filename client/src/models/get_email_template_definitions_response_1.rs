...
pub struct GetEmailTemplateDefinitionsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "definitions", skip_serializing_if = "Option::is_none")]
    pub definitions: Option<Vec<models::EmailTemplateDefinition>>,
...
impl GetEmailTemplateDefinitionsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetEmailTemplateDefinitionsResponse1 {
