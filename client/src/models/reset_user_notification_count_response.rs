...
pub struct ResetUserNotificationCountResponse {
    #[serde(rename = "status")]
...
impl ResetUserNotificationCountResponse {
    pub fn new(status: models::ApiStatus) -> ResetUserNotificationCountResponse {
