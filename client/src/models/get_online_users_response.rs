...
pub struct GetOnlineUsersResponse {
    ...
    #[serde(rename = "anonCount", skip_serializing_if = "Option::is_none")]
    pub anon_count: Option<f64>,
...
impl GetOnlineUsersResponse {
    pub fn new(status: models::ApiStatus) -> GetOnlineUsersResponse {
