...
pub struct DeleteEmailTemplateRenderErrorResponse {
    #[serde(rename = "status")]
...
impl DeleteEmailTemplateRenderErrorResponse {
    pub fn new(status: models::ApiStatus) -> DeleteEmailTemplateRenderErrorResponse {
