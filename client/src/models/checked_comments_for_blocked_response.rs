...
pub struct CheckedCommentsForBlockedResponse {
    /// Construct a type with a set of properties K of type T
    #[serde(rename = "commentStatuses", skip_serializing_if = "Option::is_none")]
    pub comment_statuses: Option<std::collections::HashMap<String, bool>>,
    #[serde(rename = "status")]
...
impl CheckedCommentsForBlockedResponse {
    pub fn new(status: models::ApiStatus) -> CheckedCommentsForBlockedResponse {
