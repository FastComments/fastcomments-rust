...
pub struct GetPendingWebhookEvents200Response {
    #[serde(rename = "status")]
...
impl GetPendingWebhookEvents200Response {
    pub fn new(status: models::ApiStatus, pending_webhook_events: Vec<models::PendingCommentToSyncOutbound>, reason: String, code: String) -> GetPendingWebhookEvents200Response {
