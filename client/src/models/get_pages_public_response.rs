...
pub struct GetPagesPublicResponse {
    ...
    pub pages: Option<Vec<models::PublicPage>>,
    #[serde(rename = "status")]
...
impl GetPagesPublicResponse {
    pub fn new(status: models::ApiStatus) -> GetPagesPublicResponse {
