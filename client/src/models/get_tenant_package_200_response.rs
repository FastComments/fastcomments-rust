...
pub struct GetTenantPackage200Response {
    #[serde(rename = "status")]
...
impl GetTenantPackage200Response {
    pub fn new(status: models::ApiStatus, tenant_package: models::TenantPackage, reason: String, code: String) -> GetTenantPackage200Response {
