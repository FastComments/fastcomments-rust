...
pub struct GetCachedNotificationCount200Response {
    #[serde(rename = "status")]
...
impl GetCachedNotificationCount200Response {
    pub fn new(status: models::ApiStatus, data: models::UserNotificationCount, reason: String, code: String) -> GetCachedNotificationCount200Response {
