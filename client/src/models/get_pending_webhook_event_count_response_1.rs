...
pub struct GetPendingWebhookEventCountResponse1 {
    #[serde(rename = "status")]
...
impl GetPendingWebhookEventCountResponse1 {
    pub fn new(status: models::ApiStatus) -> GetPendingWebhookEventCountResponse1 {
