...
pub struct GetUserBanPreferenceResponse {
    #[serde(rename = "preferences", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub preferences: Option<Option<Box<models::ApiModerateUserBanPreferences>>>,
    #[serde(rename = "status")]
...
impl GetUserBanPreferenceResponse {
    pub fn new(status: models::ApiStatus) -> GetUserBanPreferenceResponse {
