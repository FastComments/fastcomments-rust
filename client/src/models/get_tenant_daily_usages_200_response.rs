...
pub struct GetTenantDailyUsages200Response {
    #[serde(rename = "status")]
...
impl GetTenantDailyUsages200Response {
    pub fn new(status: models::ApiStatus, tenant_daily_usages: Vec<models::ApiTenantDailyUsage>, reason: String, code: String) -> GetTenantDailyUsages200Response {
