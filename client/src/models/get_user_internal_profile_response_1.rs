...
pub struct GetUserInternalProfileResponse1 {
    #[serde(rename = "profile", skip_serializing_if = "Option::is_none")]
    pub profile: Option<Box<models::GetUserInternalProfileResponseProfile>>,
    #[serde(rename = "status")]
...
impl GetUserInternalProfileResponse1 {
    pub fn new(status: models::ApiStatus) -> GetUserInternalProfileResponse1 {
