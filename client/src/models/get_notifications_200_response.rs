...
pub struct GetNotifications200Response {
    ...
    pub notifications: Vec<models::UserNotification>,
    #[serde(rename = "reason")]
    pub reason: String,
    #[serde(rename = "code")]
    pub code: String,
...
impl GetNotifications200Response {
    pub fn new(status: models::ApiStatus, notifications: Vec<models::UserNotification>, reason: String, code: String) -> GetNotifications200Response {
