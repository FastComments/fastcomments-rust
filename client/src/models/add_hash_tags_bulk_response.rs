...
pub struct AddHashTagsBulkResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::BulkCreateHashTagsResponseResultsInner>>,
...
impl AddHashTagsBulkResponse {
    pub fn new(status: models::ApiStatus) -> AddHashTagsBulkResponse {
