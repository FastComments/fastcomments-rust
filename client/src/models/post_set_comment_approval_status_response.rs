...
pub struct PostSetCommentApprovalStatusResponse {
...
impl PostSetCommentApprovalStatusResponse {
    pub fn new(status: models::ApiStatus) -> PostSetCommentApprovalStatusResponse {
