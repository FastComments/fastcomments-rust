...
pub struct GetUserBadgeProgressByUserIdResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "userBadgeProgress", skip_serializing_if = "Option::is_none")]
    pub user_badge_progress: Option<Box<models::UserBadgeProgress>>,
...
impl GetUserBadgeProgressByUserIdResponse {
    pub fn new(status: models::ApiStatus) -> GetUserBadgeProgressByUserIdResponse {
        GetUserBadgeProgressByUserIdResponse {
            status,
            user_badge_progress: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
