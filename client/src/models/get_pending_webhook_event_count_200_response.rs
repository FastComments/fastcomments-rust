...
pub struct GetPendingWebhookEventCount200Response {
    #[serde(rename = "status")]
...
impl GetPendingWebhookEventCount200Response {
    pub fn new(status: models::ApiStatus, count: f64, reason: String, code: String) -> GetPendingWebhookEventCount200Response {
