...
impl CheckBlockedCommentsResponse {
    pub fn new(comment_statuses: std::collections::HashMap<String, bool>, status: models::ImportedApiStatusPeriodFailed, reason: String, code: String) -> CheckBlockedCommentsResponse {
