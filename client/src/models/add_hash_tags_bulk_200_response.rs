...
pub struct AddHashTagsBulk200Response {
    #[serde(rename = "status")]
...
impl AddHashTagsBulk200Response {
    pub fn new(status: models::ApiStatus, results: Vec<models::AddHashTag200Response>, reason: String, code: String) -> AddHashTagsBulk200Response {
