...
pub struct GetQuestionConfig200Response {
    #[serde(rename = "status")]
...
impl GetQuestionConfig200Response {
    pub fn new(status: models::ApiStatus, question_config: models::QuestionConfig, reason: String, code: String) -> GetQuestionConfig200Response {
