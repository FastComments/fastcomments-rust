...
pub struct PostApiExportResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "batchJobId", skip_serializing_if = "Option::is_none")]
...
impl PostApiExportResponse {
    pub fn new(status: models::ApiStatus) -> PostApiExportResponse {
