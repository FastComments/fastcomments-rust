...
pub struct SetCommentTextResponse1 {
    #[serde(rename = "comment", skip_serializing_if = "Option::is_none")]
    pub comment: Option<Box<models::SetCommentTextResult>>,
    #[serde(rename = "status")]
...
impl SetCommentTextResponse1 {
    pub fn new(status: models::ApiStatus) -> SetCommentTextResponse1 {
