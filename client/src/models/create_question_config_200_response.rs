...
pub struct CreateQuestionConfig200Response {
    #[serde(rename = "status")]
...
impl CreateQuestionConfig200Response {
    pub fn new(status: models::ApiStatus, question_config: models::QuestionConfig, reason: String, code: String) -> CreateQuestionConfig200Response {
