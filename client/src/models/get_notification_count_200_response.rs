...
pub struct GetNotificationCount200Response {
    #[serde(rename = "status")]
...
impl GetNotificationCount200Response {
    pub fn new(status: models::ApiStatus, count: f64, reason: String, code: String) -> GetNotificationCount200Response {
