...
pub struct GetTenantPackagesResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantPackages", skip_serializing_if = "Option::is_none")]
    pub tenant_packages: Option<Vec<models::TenantPackage>>,
...
impl GetTenantPackagesResponse1 {
    pub fn new(status: models::ApiStatus) -> GetTenantPackagesResponse1 {
        GetTenantPackagesResponse1 {
            status,
            tenant_packages: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
