...
pub struct GetVotesForUser200Response {
    #[serde(rename = "status")]
...
impl GetVotesForUser200Response {
    pub fn new(status: models::ApiStatus, applied_authorized_votes: Vec<models::PublicVote>, applied_anonymous_votes: Vec<models::PublicVote>, pending_votes: Vec<models::PublicVote>, reason: String, code: String) -> GetVotesForUser200Response {
