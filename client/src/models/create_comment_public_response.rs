...
pub struct CreateCommentPublicResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "comment", skip_serializing_if = "Option::is_none")]
    pub comment: Option<Box<models::PublicComment>>,
...
impl CreateCommentPublicResponse {
    pub fn new(status: models::ApiStatus) -> CreateCommentPublicResponse {
