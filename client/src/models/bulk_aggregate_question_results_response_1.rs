...
pub struct BulkAggregateQuestionResultsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    /// Construct a type with a set of properties K of type T
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<std::collections::HashMap<String, models::QuestionResultAggregationOverall>>,
...
impl BulkAggregateQuestionResultsResponse1 {
    pub fn new(status: models::ApiStatus) -> BulkAggregateQuestionResultsResponse1 {
