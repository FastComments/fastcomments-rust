...
pub struct GetFeedPostsStatsResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "stats", skip_serializing_if = "Option::is_none")]
    pub stats: Option<std::collections::HashMap<String, models::FeedPostStats>>,
...
impl GetFeedPostsStatsResponse {
    pub fn new(status: models::ApiStatus) -> GetFeedPostsStatsResponse {
