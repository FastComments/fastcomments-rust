...
pub struct BulkCreateHashTagsResponseResultsInner {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "hashTag", skip_serializing_if = "Option::is_none")]
    pub hash_tag: Option<Box<models::TenantHashTag>>,
...
impl BulkCreateHashTagsResponseResultsInner {
    pub fn new(status: models::ApiStatus) -> BulkCreateHashTagsResponseResultsInner {
