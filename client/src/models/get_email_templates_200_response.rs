...
pub struct GetEmailTemplates200Response {
    #[serde(rename = "status")]
...
impl GetEmailTemplates200Response {
    pub fn new(status: models::ApiStatus, email_templates: Vec<models::CustomEmailTemplate>, reason: String, code: String) -> GetEmailTemplates200Response {
