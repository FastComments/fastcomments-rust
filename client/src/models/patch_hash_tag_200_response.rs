...
pub struct PatchHashTag200Response {
    #[serde(rename = "status")]
...
impl PatchHashTag200Response {
    pub fn new(status: models::ApiStatus, hash_tag: models::TenantHashTag, reason: String, code: String) -> PatchHashTag200Response {
