...
pub struct GetUserBadgeProgressListResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "userBadgeProgresses", skip_serializing_if = "Option::is_none")]
    pub user_badge_progresses: Option<Vec<models::UserBadgeProgress>>,
...
impl GetUserBadgeProgressListResponse {
    pub fn new(status: models::ApiStatus) -> GetUserBadgeProgressListResponse {
        GetUserBadgeProgressListResponse {
            status,
            user_badge_progresses: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
