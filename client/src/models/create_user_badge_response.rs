...
pub struct CreateUserBadgeResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "userBadge", skip_serializing_if = "Option::is_none")]
    pub user_badge: Option<Box<models::UserBadge>>,
...
impl CreateUserBadgeResponse {
    pub fn new(status: models::ApiStatus) -> CreateUserBadgeResponse {
