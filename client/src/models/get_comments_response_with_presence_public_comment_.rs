...
pub struct GetCommentsResponseWithPresencePublicComment {
...
impl GetCommentsResponseWithPresencePublicComment {
    pub fn new(status: String, comments: Vec<models::PublicComment>, user: Option<models::UserSessionInfo>, page_number: i32) -> GetCommentsResponseWithPresencePublicComment {
