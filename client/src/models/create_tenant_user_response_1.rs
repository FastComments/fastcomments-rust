...
pub struct CreateTenantUserResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantUser", skip_serializing_if = "Option::is_none")]
    pub tenant_user: Option<Box<models::User>>,
...
impl CreateTenantUserResponse1 {
    pub fn new(status: models::ApiStatus) -> CreateTenantUserResponse1 {
