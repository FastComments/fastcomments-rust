...
pub struct GetUserBadgesResponse {
    ...
    #[serde(rename = "userBadges", skip_serializing_if = "Option::is_none")]
    pub user_badges: Option<Vec<models::UserBadge>>,
...
impl GetUserBadgesResponse {
    pub fn new(status: models::ApiStatus) -> GetUserBadgesResponse {
