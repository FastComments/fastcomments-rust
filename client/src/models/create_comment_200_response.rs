...
impl CreateComment200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, comment: models::PublicComment, user: Option<models::UserSessionInfo>, reason: String, code: String) -> CreateComment200Response {
