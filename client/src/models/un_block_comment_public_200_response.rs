...
pub struct UnBlockCommentPublic200Response {
    #[serde(rename = "status")]
...
impl UnBlockCommentPublic200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, comment_statuses: std::collections::HashMap<String, bool>, reason: String, code: String) -> UnBlockCommentPublic200Response {
