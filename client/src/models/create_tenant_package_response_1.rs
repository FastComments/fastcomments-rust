...
pub struct CreateTenantPackageResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantPackage", skip_serializing_if = "Option::is_none")]
    pub tenant_package: Option<Box<models::TenantPackage>>,
...
impl CreateTenantPackageResponse1 {
    pub fn new(status: models::ApiStatus) -> CreateTenantPackageResponse1 {
