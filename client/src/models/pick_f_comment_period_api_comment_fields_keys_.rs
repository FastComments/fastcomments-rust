...
impl PickFCommentPeriodApiCommentFieldsKeys {
    ...
    pub fn new(date: String, _id: String, tenant_id: String, url_id: String, url: String, commenter_name: String, comment: String, comment_html: String, verified: bool, approved: bool, locale: String) -> PickFCommentPeriodApiCommentFieldsKeys {
