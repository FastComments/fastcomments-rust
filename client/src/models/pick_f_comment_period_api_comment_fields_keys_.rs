...
/// PickFCommentPeriodApiCommentFieldsKeys : From T, pick a set of properties whose keys are in the union K
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PickFCommentPeriodApiCommentFieldsKeys {
    #[serde(rename = "_id")]
    pub _id: String,
    #[serde(rename = "urlId")]
    pub url_id: String,
...
impl PickFCommentPeriodApiCommentFieldsKeys {
    /// From T, pick a set of properties whose keys are in the union K
    pub fn new(_id: String, url_id: String, url: String, date: String, tenant_id: String, commenter_name: String, comment: String, comment_html: String, verified: bool, approved: bool, locale: String) -> PickFCommentPeriodApiCommentFieldsKeys {
