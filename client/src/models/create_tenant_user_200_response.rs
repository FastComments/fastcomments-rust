...
pub struct CreateTenantUser200Response {
    #[serde(rename = "status")]
...
impl CreateTenantUser200Response {
    pub fn new(status: models::ApiStatus, tenant_user: models::User, reason: String, code: String) -> CreateTenantUser200Response {
