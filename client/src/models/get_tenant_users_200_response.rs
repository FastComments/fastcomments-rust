...
pub struct GetTenantUsers200Response {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantUsers")]
    pub tenant_users: Vec<models::User>,
    #[serde(rename = "reason")]
    pub reason: String,
    #[serde(rename = "code")]
    pub code: String,
...
impl GetTenantUsers200Response {
    pub fn new(status: models::ApiStatus, tenant_users: Vec<models::User>, reason: String, code: String) -> GetTenantUsers200Response {
