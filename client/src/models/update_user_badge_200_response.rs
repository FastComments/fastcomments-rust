...
pub struct UpdateUserBadge200Response {
    #[serde(rename = "status")]
...
impl UpdateUserBadge200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, reason: String, code: String) -> UpdateUserBadge200Response {
