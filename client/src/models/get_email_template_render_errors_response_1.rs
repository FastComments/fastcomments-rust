...
pub struct GetEmailTemplateRenderErrorsResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "renderErrors", skip_serializing_if = "Option::is_none")]
    pub render_errors: Option<Vec<models::EmailTemplateRenderErrorResponse>>,
...
impl GetEmailTemplateRenderErrorsResponse1 {
    pub fn new(status: models::ApiStatus) -> GetEmailTemplateRenderErrorsResponse1 {
