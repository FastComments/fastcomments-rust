...
pub struct GetEmailTemplateRenderErrors200Response {
    #[serde(rename = "status")]
...
impl GetEmailTemplateRenderErrors200Response {
    pub fn new(status: models::ApiStatus, render_errors: Vec<models::EmailTemplateRenderErrorResponse>, reason: String, code: String) -> GetEmailTemplateRenderErrors200Response {
