...
impl PickOmitFCommentPeriodDatePeriodPublicCommentPubSubFieldsKeys {
    ...
    pub fn new(date: Option<serde_json::Value>, _id: String, tenant_id: String, url_id: String, url: String, commenter_name: String, comment: String, comment_html: String, verified: bool, approved: bool, locale: String) -> PickOmitFCommentPeriodDatePeriodPublicCommentPubSubFieldsKeys {
