...
pub struct GetEmailTemplatesResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "emailTemplates", skip_serializing_if = "Option::is_none")]
    pub email_templates: Option<Vec<models::CustomEmailTemplate>>,
...
impl GetEmailTemplatesResponse1 {
    pub fn new(status: models::ApiStatus) -> GetEmailTemplatesResponse1 {
