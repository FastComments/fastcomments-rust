...
impl ApiCommentBase {
    pub fn new(_id: String, approved: bool, comment: String, comment_html: String, commenter_name: String, date: Option<String>, locale: Option<String>, tenant_id: String, url: String, url_id: String, verified: bool) -> ApiCommentBase {
        ApiCommentBase {
            _id,
