...
pub struct GetCommentVoteUserNamesResponse {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "voteUserNames", skip_serializing_if = "Option::is_none")]
    pub vote_user_names: Option<Vec<String>>,
...
impl GetCommentVoteUserNamesResponse {
    pub fn new(status: models::ApiStatus) -> GetCommentVoteUserNamesResponse {
        GetCommentVoteUserNamesResponse {
            status,
            vote_user_names: None,
            has_more: None,
            reason: None,
            code: None,
            secondary_code: None,
