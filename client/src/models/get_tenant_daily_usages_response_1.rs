...
pub struct GetTenantDailyUsagesResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantDailyUsages", skip_serializing_if = "Option::is_none")]
    pub tenant_daily_usages: Option<Vec<models::ApiTenantDailyUsage>>,
...
impl GetTenantDailyUsagesResponse1 {
    pub fn new(status: models::ApiStatus) -> GetTenantDailyUsagesResponse1 {
        GetTenantDailyUsagesResponse1 {
            status,
            tenant_daily_usages: None,
            reason: None,
            code: None,
            secondary_code: None,
            banned_until: None,
