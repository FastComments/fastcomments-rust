...
impl CreateCommentPublic200Response {
    pub fn new(status: models::ApiStatus, comment: models::PublicComment, user: Option<models::UserSessionInfo>, reason: String, code: String) -> CreateCommentPublic200Response {
