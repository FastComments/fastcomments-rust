...
pub struct GetTenantUsersResponse1 {
    #[serde(rename = "status")]
    pub status: models::ApiStatus,
    #[serde(rename = "tenantUsers", skip_serializing_if = "Option::is_none")]
    pub tenant_users: Option<Vec<models::User>>,
...
impl GetTenantUsersResponse1 {
    pub fn new(status: models::ApiStatus) -> GetTenantUsersResponse1 {
