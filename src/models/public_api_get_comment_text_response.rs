...
impl PublicApiGetCommentTextResponse {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, comment_text: String, sanitized_comment_text: String, reason: String, code: String) -> PublicApiGetCommentTextResponse {
