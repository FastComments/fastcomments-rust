...
pub struct BlockFromComment200Response {
    #[serde(rename = "status")]
...
impl BlockFromComment200Response {
    pub fn new(status: models::ImportedApiStatusPeriodFailed, comment_statuses: std::collections::HashMap<String, bool>, reason: String, code: String) -> BlockFromComment200Response {
