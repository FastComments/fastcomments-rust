...
impl PublicApiSetCommentTextResponse {
    pub fn new(comment: models::PickFCommentPeriodApprovedOrCommentHtml, status: models::ImportedApiStatusPeriodFailed, reason: String, code: String) -> PublicApiSetCommentTextResponse {
